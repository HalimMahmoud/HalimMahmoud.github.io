        ...
        >
          ...
          <div className="flex-1 space-y-6 text-center lg:text-left">
            ...
            <motion.div 
              ...
              className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-theme-border bg-theme-bg-secondary/60 backdrop-blur-md text-[11px] font-semibold text-secondary max-w-full"
            >
              <span className="flex h-2 w-2 relative shrink-0">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-brand-cyan opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-brand-cyan"></span>
              </span>
              <span className="leading-snug">Available for Full-Stack / React Developer roles</span>
            </motion.div>
            ...
            >
              ...
              <a className="btn text-xs flex items-center gap-1.5" href="/AbdelhalimMahmoud@FullStackDeveloper.pdf" download>
          ...
          <motion.div 
            variants={itemVariants}
            className="flex-1 w-full max-w-sm sm:max-w-md lg:max-w-none grid grid-cols-2 gap-3 sm:gap-4 relative"
          >
            ...
            <GlowCard glowColor="cyan" className="p-3 sm:p-5 hover:-translate-y-0.5 hover:shadow-lg">
              ...
              <h3 className="text-lg sm:text-2xl font-extrabold text-primary mt-3 sm:mt-4 font-display">Full-Stack</h3>
              <p className="text-[10px] sm:text-xs text-secondary mt-1 leading-snug hidden sm:block">Designing modern, type-safe web applications with React, Next.js, Node.js, and database APIs.</p>
            </GlowCard>

            {/* Metric Card 2: Precision */}
            <GlowCard glowColor="purple" className="p-3 sm:p-5 hover:-translate-y-0.5 hover:shadow-lg">
              ...
              <h3 className="text-lg sm:text-2xl font-extrabold text-primary mt-3 sm:mt-4 font-display">Detail Focus</h3>
              <p className="text-[10px] sm:text-xs text-secondary mt-1 leading-snug hidden sm:block">Ensuring high code quality, robust error handling, and strict type-safety across the codebase.</p>
            </GlowCard>

            {/* Metric Card 3: DevOps */}
            <GlowCard glowColor="pink" className="p-3 sm:p-5 col-span-2 hover:-translate-y-0.5 hover:shadow-lg">
              <div className="absolute top-0 right-0 w-16 h-16 bg-gradient-to-bl from-brand-pink/5 to-transparent rounded-bl-3xl group-hover:scale-110 transition-transform pointer-events-none" />
                ...
                <div>
                  <h4 className="font-bold text-primary text-xs sm:text-sm">DevOps learning (In Progress)</h4>
                  <p className="text-[10px] sm:text-xs text-secondary mt-1 leading-relaxed hidden xs:block">
